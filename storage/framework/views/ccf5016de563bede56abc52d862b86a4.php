...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Colegio de Arquitectos del Oro'); ?></title>
    ...
    <header class="bg-[#153411] shadow-md sticky top-0 z-50" x-data="{ open: false }">
        <div class="container mx-auto flex justify-between items-center py-4 px-4">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('imagenes/logo .jpg')); ?>" alt="Logo Colegio de Arquitectos" class="h-12 w-12 rounded-full bg-white border-4 border-[#D7A74B] shadow-md">
            ...
            <nav class="hidden md:flex gap-6">
                ...
                <?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($item['url']); ?>"
                       ...
                       <?php echo e($current == ltrim(parse_url($item['url'], PHP_URL_PATH), '/') ? 'text-[#D7A74B]' : 'text-white'); ?>">
                        ...
                        <span class="absolute left-0 -bottom-1 w-full h-0.5 bg-[#D7A74B] scale-x-0 group-hover:scale-x-100 transition-transform origin-left
                            <?php echo e($current == ltrim(parse_url($item['url'], PHP_URL_PATH), '/') ? 'scale-x-100' : ''); ?>"></span>
                    </a>
    ...
    <footer class="bg-[#153411] text-gold py-6 mt-8 border-t border-gold">
        <div class="container mx-auto flex flex-col md:flex-row justify-between items-center px-4">
            <div class="mb-2 md:mb-0">
                &copy; <?php echo e(date('Y')); ?> Colegio de Arquitectos del Oro. Todos los derechos reservados.
            </div>
            <div class="space-x-4">
...
<?php /**PATH C:\Users\karen\colegioArquitectos\resources\views/layouts/app.blade.php ENDPATH**/ ?>